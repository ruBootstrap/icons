...
(function () {
  ...
  const btnHtml = '<div class="bd-clipboard"><button type="button" class="btn-clipboard" title="Скопировать в буфер обмена"><i class="bi bi-clipboard" aria-hidden="true"></i></button></div>'
  ...
  clipboard.on('error', () => {
    ...
    const fallbackMsg = `Нажмите ${modifierKey}C для копирования`
